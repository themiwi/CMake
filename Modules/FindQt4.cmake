...
IF (QT4_QMAKE_FOUND)
  ...
  # On APPLE check that QtDBus isn't a bogus installation (QTBUG-6429)
  IF(QT_USE_COCOA AND QT_USE_FRAMEWORKS AND QT_QTDBUS_LIBRARY_RELEASE AND
      NOT EXISTS "${QT_QTDBUS_LIBRARY_RELEASE}/Versions/4/QDBus")
    SET(QT_QTDBUS_LIBRARY_RELEASE QT_QTDBUS_LIBRARY_RELEASE-NOTFOUND
      CACHE PATH
      "Path to QtDBus framework (purged from cache because buggy installation detected)"
      FORCE)
  ENDIF(QT_USE_COCOA AND QT_USE_FRAMEWORKS AND QT_QTDBUS_LIBRARY_RELEASE AND
    NOT EXISTS "${QT_QTDBUS_LIBRARY_RELEASE}/Versions/4/QDBus")
